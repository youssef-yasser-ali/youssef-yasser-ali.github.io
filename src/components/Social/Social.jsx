    ...
    <div className="socialContainer">
      <ul className="social">
        <li className="social-item">
          <a href="https://github.com/youssef-yasser-ali" target="_blank">
            <svg
        ...
        <li className="social-item">
          <a
            href="https://www.linkedin.com/in/youssef-yasser-ali/"
            target="_blank"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <li className="social-item">
          <a href="https://www.facebook.com/YousefYaserAli" target="_blank">
            <svg
              style={{ width: 23 }}
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
